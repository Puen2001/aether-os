...
origin: mturac/recsys-pipeline-architect (MIT, indep reimpl of xAI For-You pattern, Apache-2.0) — via affaan-m/ECC bundle, adapted
---
...
_This copy is `SKILL.md` only. The 5 load-on-demand reference docs and 3 runnable example scaffolds described above live in the upstream repo (`github.com/mturac/recsys-pipeline-architect`) — pull from there if a build needs them._
